...
type Props$2 = React.SVGProps<SVGSVGElement> & {
    type: IconType;
};
declare function Icon({ type, ...svgProps }: Props$2): JSX.Element;
 ...
 */
declare function getXAxisFromTimeRange(timeRange: TimeRange): Axis;
 ...
 */
declare function useInteractiveControls(readOnly: boolean): InteractiveControls & InteractiveControlsState;
 ...
 */
declare function useMouseControls<E extends Element>({ interactiveControls: { dragKeyPressed, zoomKeyPressed, mouseInteraction, resetMouseInteraction, startDrag, startZoom, updateEndValue, }, timeRange, onChangeTimeRange, dimensions, }: Props$1): MouseControls<E>;
 ...
 * is applied.
 */
declare function useScales({ xMax, yMax }: Dimensions, mouseInteraction: MouseInteractionState): Scales;

declare function getCursorFromState(state: InteractiveControlsState): string;

declare function getTicks(axis: Axis, max: number, scale: Scale, numTicks: number, getMaxAllowedTick: (ticks: Array<number>, maxValue: number) => number): Array<number>;
/**
 ...
 */
declare const getMaxXTickValue: (ticks: Array<number>, maxValue: number) => number;
...
export { AbstractChart, Area, AreaPoint, Axis, ButtonGroup, ChartTheme, CloseTooltipFn, CombinedSourceData, ControlsSet, ControlsSetLabel, FormatterKind, GraphType, Icon, IconButton, Line, Metric, MetricsChart, MetricsChartProps, MouseInteractionState, OtelMetadata, Point, ProviderEvent, Rectangle, SeriesSource, Shape, ShapeList, SparkChart, StackingType, TickFormatter, TickFormatters, TickFormattersFactory, TimeRange, Timeseries, TimeseriesSourceData, Timestamp, ToggleTimeseriesEvent, TooltipAnchor, VirtualElement, generate, generateFromTimeseries, getBytesFormatterForAxis, getCursorFromState, getDurationFormatterForAxis, getExponentFormatter, getFormatterForAxis, getMaxXTickValue, getPercentageFormatter, getScientificFormatterForAxis, getTicks, getTimeFormatterForAxis, getXAxisFromTimeRange, useInteractiveControls, useMouseControls, useScales };
