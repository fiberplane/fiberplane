...
function XAxis({ formatter , axisLinesShown , scales: { xMax , xScale , yMax  } , strokeColor , strokeDasharray , ticks , xAxis: { maxValue , minValue  }  }) {
    ...
    return /*#__PURE__*/ jsxs("g", {
        ...
        children: [
            axisLinesShown && /*#__PURE__*/ jsx("line", {
                x1: 0,
                y1: 0,
                x2: xMax,
                y2: 0,
            ...
            formatter && ticks.map((time, index)=>/*#__PURE__*/ jsx("text", {
...
function YAxis({ formatter , axisLinesShown , scales: { xMax , yMax , yScale  } , strokeColor , strokeDasharray , ticks  }) {
    const { axisColor , axisFontSize , axisFontFamily , axisFontStyle , axisFontWeight , axisLetterSpacing  } = useContext(ChartThemeContext);
    ...
    return /*#__PURE__*/ jsxs("g", {
        children: [
            axisLinesShown && /*#__PURE__*/ jsxs(Fragment, {
                children: [
                    /*#__PURE__*/ jsx("line", {
                        x1: 0,
                        y1: 0,
            ...
            formatter && ticks.map((value, index)=>(index > 0 || index < numTicks - 1) && value.valueOf() !== 0 ? // biome-ignore lint/suspicious/noArrayIndexKey: no better key available
                /*#__PURE__*/ jsx("text", {
                    x: 0,
                    y: yScale(value),
                    ...tickLabelProps,
...
const GridWithAxes = /*#__PURE__*/ memo(function GridWithAxes({ chart , gridColumnsShown =true , gridRowsShown =true , axisLinesShown =true , gridDasharray , scales , shouldAnimateYScale , tickFormatters  }) {
    ...
    return /*#__PURE__*/ jsxs(Fragment, {
        children: [
            ...
            axisLinesShown || tickFormatters.xFormatter ? /*#__PURE__*/ jsx(XAxis, {
            ...
            axisLinesShown || tickFormatters.yFormatter ? /*#__PURE__*/ jsx(YAxis, {
...
function CoreChart({ areaGradientShown =true , chart , getShapeListColor , onChangeTimeRange , readOnly =false , showTooltip , timeRange , ...props }) {
 ...
 */ function attachTickSuggestions(axis, suggestions) {
...
export { ButtonGroup, ControlsSet, ControlsSetLabel, Icon, IconButton, MetricsChart, SparkChart, generate, generateFromTimeseries, getBytesFormatterForAxis, getCursorFromState, getDurationFormatterForAxis, getExponentFormatter, getFormatterForAxis, getMaxXTickValue, getPercentageFormatter, getScientificFormatterForAxis, getTicks, getTimeFormatterForAxis, getXAxisFromTimeRange, useInteractiveControls, useMouseControls, useScales };
