...
describe("logIfDebug", () => {
    ...
    describe("with boolean flag", () => {
        it("should log when debug is true", () => {
            ...
            expect(console.debug).toHaveBeenCalledWith("[fiberplane:debug] ", "test message", "param1", "param2");
        });
    ...
    describe("edge cases", () => {
        it("should handle undefined params array", () => {
            ...
            expect(console.debug).toHaveBeenCalledWith("[fiberplane:debug] ", "test message");
        });
