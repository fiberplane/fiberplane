...
export interface ResolvedEmbeddedOptions<E extends Env> extends Omit<EmbeddedOptions<E>, "cdn"> {
    mountedPath: string;
    fpxEndpoint?: string;
    userApp: Hono<E>;
    userEnv: Env;
...
export interface SanitizedEmbeddedOptions<E extends Env> extends Omit<ResolvedEmbeddedOptions<E>, "apiKey"> {
}
