...
![Architecture with two Queues](@/assets/blog/2025-02-17-two-queues-architecture.png)
</figure>

<figure class="dark:sl-hidden"> 
![Architecture with two Queues](@/assets/blog/2025-02-17-two-queues-architecture-light.png)
</figure>
