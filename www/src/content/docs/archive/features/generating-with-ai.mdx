...
import fpxGenAiGenerateBody from "@/assets/docs-archive/gen-ai-requests--generate.gif";
import fpxGenAiSettings from "@/assets/docs-archive/gen-ai-requests--settings.png";
import fpxGenAiSettingsProvider from "@/assets/docs-archive/gen-ai-requests--settings-provider.png";
import fpxGenAiHostile from "@/assets/docs-archive/gen-ai-requests--hostile.png";
...
<Image src={fpxGenAiSettingsProvider} alt="Settings Provider" />
