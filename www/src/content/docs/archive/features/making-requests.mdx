...
import FirstRequest from "@/assets/docs-archive/making-requests--make-request.gif";
import CreateGoose from "@/assets/docs-archive/making-requests--create-goose.png";
import CurlRequest from "@/assets/docs-archive/making-requests--curl.png";
import BodySelector from "@/assets/docs-archive/making-requests--body-type.png";
import FormBodyExample from "@/assets/docs-archive/making-requests--body-type-form-data.png";
import RequestHistory from "@/assets/docs-archive/making-requests--history.png";
import CustomRoutes from "@/assets/docs-archive/making-requests--custom-routes.png";
