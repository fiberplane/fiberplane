...
![Public URL active](@/assets/docs-archive/webhooks--settings.png)
...
![Public URL active hover card](@/assets/docs-archive/webhooks--public-url-hover-card.png)
...
![Proxied request example](@/assets/docs-archive/webhooks--proxied-badge.png)
