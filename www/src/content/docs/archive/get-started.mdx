...
import getStartedHonoRawCode from "@/content/docs/docs/get-started-cf.ts.example?raw";
import getStartedNodeRawCode from "@/content/docs/docs/get-started-node.ts.example?raw";
