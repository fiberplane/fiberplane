...
use crate::fiberplane::{
    generate_stacked_bar_chart_from_timeseries, GraphType, Metric, StackingType, TimeRange,
...
#[test]
fn test_generate_stacked_bar_chart_from_timeseries() {
    ...
    let chart = generate_stacked_bar_chart_from_timeseries(TimeseriesSourceData {
    ...
    let svg = chart_to_svg(
        ...
        &ChartOptions {
            ...
            y_formatter: Some(FormatterKind::Exponent),
        },
    );
